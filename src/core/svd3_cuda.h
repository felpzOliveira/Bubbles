...
float a31, float a32, float a33, // input A
...
)
{
    ...
    #define rsqrt_rn(a) (1.0f / std::sqrt(a))
#else
    #define add_rn(a, b) __fadd_rn(a, b)
    #define sub_rn(a, b) __fsub_rn(a, b)
    #define rsqrt_rn(a) __frsqrt_rn(a)
#endif
 ...
 //###########################################################
    for (int i = 0; i < 4; i++)
    {
        ...
        Stmp1.f = Ssh.f*Ssh.f;
        Stmp2.f = Sch.f*Sch.f;
        Stmp3.f = add_rn(Stmp1.f, Stmp2.f);
        Stmp4.f = rsqrt_rn(Stmp3.f);
        ...
        Stmp1.f = Ssh.f * Ssh.f;
        Stmp2.f = Sch.f * Sch.f;
        Sc.f = sub_rn(Stmp2.f, Stmp1.f);
        Ss.f = Sch.f * Ssh.f;
        Ss.f = add_rn(Ss.f, Ss.f);
  ...
  //###########################################################
        ...
        Ss31.f = Sc.f * Ss31.f;
        Ss32.f = Sc.f * Ss32.f;
        Ss31.f = add_rn(Stmp2.f, Ss31.f);
        Ss32.f = sub_rn(Ss32.f, Stmp1.f);
        ...
        Ss11.f = add_rn(Ss11.f, Stmp1.f);
        Ss22.f = add_rn(Ss22.f, Stmp3.f);
        Stmp4.f = sub_rn(Stmp4.f, Stmp2.f);
        Stmp2.f = add_rn(Ss21.f, Ss21.f);
        Ss21.f = Ss21.f*Stmp4.f;
        Stmp4.f = Sc.f*Ss.f;
        Stmp2.f = Stmp2.f*Stmp4.f;
        Stmp5.f = Stmp5.f*Stmp4.f;
        Ss11.f = add_rn(Ss11.f, Stmp2.f);
        Ss21.f = sub_rn(Ss21.f, Stmp5.f);
        Ss22.f = sub_rn(Ss22.f, Stmp2.f);
  ...
  //###########################################################
        ...
        Sqvvz.f = add_rn(Sqvvz.f, Ssh.f);
        Sqvs.f = sub_rn(Sqvs.f, Stmp3.f);
        Sqvvx.f = add_rn(Sqvvx.f, Stmp2.f);
        Sqvvy.f = sub_rn(Sqvvy.f, Stmp1.f);
  ...
  //###########################################################
        ...
        Ss21.f = Sc.f*Ss21.f;
        Ss31.f = Sc.f*Ss31.f;
        Ss21.f = add_rn(Stmp2.f, Ss21.f);
        Ss31.f = sub_rn(Ss31.f, Stmp1.f);
        ...
        Ss22.f = add_rn(Ss22.f, Stmp1.f);
        Ss33.f = add_rn(Ss33.f, Stmp3.f);
        Stmp4.f = sub_rn(Stmp4.f, Stmp2.f);
        Stmp2.f = add_rn(Ss32.f, Ss32.f);
        Ss32.f = Ss32.f*Stmp4.f;
        Stmp4.f = Sc.f*Ss.f;
        Stmp2.f = Stmp2.f*Stmp4.f;
        Stmp5.f = Stmp5.f*Stmp4.f;
        Ss22.f = add_rn(Ss22.f, Stmp2.f);
        Ss32.f = sub_rn(Ss32.f, Stmp5.f);
        Ss33.f = sub_rn(Ss33.f, Stmp2.f);
  ...
  //###########################################################
        ...
        Sqvvx.f = add_rn(Sqvvx.f, Ssh.f);
        Sqvs.f = sub_rn(Sqvs.f, Stmp1.f);
        Sqvvy.f = add_rn(Sqvvy.f, Stmp3.f);
        Sqvvz.f = sub_rn(Sqvvz.f, Stmp2.f);
  ...
  //###########################################################
        ...
        Ss32.f = Sc.f*Ss32.f;
        Ss21.f = Sc.f*Ss21.f;
        Ss32.f = add_rn(Stmp2.f, Ss32.f);
        Ss21.f = sub_rn(Ss21.f, Stmp1.f);
        ...
        Ss33.f = Ss33.f*Stmp4.f;
        Ss11.f = Ss11.f*Stmp4.f;
        Ss33.f = add_rn(Ss33.f, Stmp1.f);
        Ss11.f = add_rn(Ss11.f, Stmp3.f);
        Stmp4.f = sub_rn(Stmp4.f, Stmp2.f);
        Stmp2.f = add_rn(Ss31.f, Ss31.f);
        Ss31.f = Ss31.f*Stmp4.f;
        Stmp4.f = Sc.f*Ss.f;
        Stmp2.f = Stmp2.f*Stmp4.f;
        Stmp5.f = Stmp5.f*Stmp4.f;
        Ss33.f = add_rn(Ss33.f, Stmp2.f);
        Ss31.f = sub_rn(Ss31.f, Stmp5.f);
        Ss11.f = sub_rn(Ss11.f, Stmp2.f);
  ...
  //###########################################################
        ...
        Sqvvy.f = add_rn(Sqvvy.f, Ssh.f);
        Sqvs.f = sub_rn(Sqvs.f, Stmp2.f);
        Sqvvz.f = add_rn(Sqvvz.f, Stmp1.f);
        Sqvvx.f = sub_rn(Sqvvx.f, Stmp3.f);
#endif
    }
 ...
 //###########################################################
    ...
    Sv22.f = sub_rn(Sv11.f, Stmp1.f);
    Sv33.f = sub_rn(Sv22.f, Stmp2.f);
    Sv33.f = add_rn(Sv33.f, Stmp3.f);
    Sv22.f = add_rn(Sv22.f, Stmp2.f);
    Sv22.f = sub_rn(Sv22.f, Stmp3.f);
    Sv11.f = add_rn(Sv11.f, Stmp1.f);
    Sv11.f = sub_rn(Sv11.f, Stmp2.f);
    Sv11.f = sub_rn(Sv11.f, Stmp3.f);
    Stmp1.f = add_rn(Sqvvx.f, Sqvvx.f);
    Stmp2.f = add_rn(Sqvvy.f, Sqvvy.f);
    Stmp3.f = add_rn(Sqvvz.f, Sqvvz.f);
    ...
    Sv12.f = sub_rn(Stmp1.f, Sv21.f);
    Sv23.f = sub_rn(Stmp2.f, Sv32.f);
    Sv31.f = sub_rn(Stmp3.f, Sv13.f);
    Sv21.f = add_rn(Stmp1.f, Sv21.f);
    Sv32.f = add_rn(Stmp2.f, Sv32.f);
    Sv13.f = add_rn(Stmp3.f, Sv13.f);
 ...
 //###########################################################
    ...
    Stmp1.f = Sv21.f*Stmp2.f;
    Sa21.f = add_rn(Sa21.f, Stmp1.f);
    Stmp1.f = Sv31.f*Stmp3.f;
    Sa21.f = add_rn(Sa21.f, Stmp1.f);
    Stmp1.f = Sv22.f*Stmp2.f;
    Sa22.f = add_rn(Sa22.f, Stmp1.f);
    Stmp1.f = Sv32.f*Stmp3.f;
    Sa22.f = add_rn(Sa22.f, Stmp1.f);
    Stmp1.f = Sv23.f*Stmp2.f;
    Sa23.f = add_rn(Sa23.f, Stmp1.f);
    Stmp1.f = Sv33.f*Stmp3.f;
    Sa23.f = add_rn(Sa23.f, Stmp1.f);
    ...
    Stmp1.f = Sv21.f*Stmp2.f;
    Sa31.f = add_rn(Sa31.f, Stmp1.f);
    Stmp1.f = Sv31.f*Stmp3.f;
    Sa31.f = add_rn(Sa31.f, Stmp1.f);
    Stmp1.f = Sv22.f*Stmp2.f;
    Sa32.f = add_rn(Sa32.f, Stmp1.f);
    Stmp1.f = Sv32.f*Stmp3.f;
    Sa32.f = add_rn(Sa32.f, Stmp1.f);
    Stmp1.f = Sv23.f*Stmp2.f;
    Sa33.f = add_rn(Sa33.f, Stmp1.f);
    Stmp1.f = Sv33.f*Stmp3.f;
    Sa33.f = add_rn(Sa33.f, Stmp1.f);
 ...
 // If columns 1-2 have been swapped, negate 2nd column of A and V so that V is still a rotation
    ...
    Stmp5.ui = Stmp5.ui&Stmp4.ui;
    Stmp4.f = 1.f;
    Stmp4.f = add_rn(Stmp4.f, Stmp5.f);
 ...
 //###########################################################
    ...
    Sa11.f = Sc.f*Sa11.f;
    Sa21.f = Sc.f*Sa21.f;
    Sa11.f = add_rn(Sa11.f, Stmp2.f);
    Sa21.f = sub_rn(Sa21.f, Stmp1.f);

    Stmp1.f = Ss.f*Sa12.f;
    Stmp2.f = Ss.f*Sa22.f;
    Sa12.f = Sc.f*Sa12.f;
    Sa22.f = Sc.f*Sa22.f;
    Sa12.f = add_rn(Sa12.f, Stmp2.f);
    Sa22.f = sub_rn(Sa22.f, Stmp1.f);

    Stmp1.f = Ss.f*Sa13.f;
    Stmp2.f = Ss.f*Sa23.f;
    Sa13.f = Sc.f*Sa13.f;
    Sa23.f = Sc.f*Sa23.f;
    Sa13.f = add_rn(Sa13.f, Stmp2.f);
    Sa23.f = sub_rn(Sa23.f, Stmp1.f);
 ...
 //###########################################################
    ...
    Su11.f = Sc.f*Su11.f;
    Su12.f = Sc.f*Su12.f;
    Su11.f = add_rn(Su11.f, Stmp2.f);
    Su12.f = sub_rn(Su12.f, Stmp1.f);

    Stmp1.f = Ss.f*Su21.f;
    Stmp2.f = Ss.f*Su22.f;
    Su21.f = Sc.f*Su21.f;
    Su22.f = Sc.f*Su22.f;
    Su21.f = add_rn(Su21.f, Stmp2.f);
    Su22.f = sub_rn(Su22.f, Stmp1.f);

    Stmp1.f = Ss.f*Su31.f;
    Stmp2.f = Ss.f*Su32.f;
    Su31.f = Sc.f*Su31.f;
    Su32.f = Sc.f*Su32.f;
    Su31.f = add_rn(Su31.f, Stmp2.f);
    Su32.f = sub_rn(Su32.f, Stmp1.f);
